...
const Dwellings = require("./dwellings.section");
const SeloHS = require("./selohs.section");
const OmakaHS = require("./omakahs.section");
const AbbaHS = require("./abbahs.section");
...
const routes = {
  ...
  dwellings: (data) => { return new Dwellings({ ...data, method: method }).display(); },
  seloHS: (data) => { return new SeloHS({ ...data, method: method }).display(); },
  omakaHS: (data) => { return new OmakaHS({ ...data, method: method }).display(); },
  AbbaHS: (data) => { return new AbbaHS({ ...data, method: method }).display(); },
...
export default {
  ...
  Dwellings: (data) => { return new Dwellings({ ...data, method: method }) },
  SeloHS: (data) => { return new SeloHS({ ...data, method: method }) },
  OmakaHS: (data) => { return new OmakaHS({ ...data, method: method }) },
  AbbaHS: (data) => { return new AbbaHS({ ...data, method: method }) },
